    ...
    return (
        <div className="group relative bg-card rounded-md p-4 transition-all duration-300 ease-out hover:shadow-lg hover:-translate-y-1">
            <div className={`aspect-[3/4] w-full overflow-hidden rounded-md shadow-sm mb-4 relative bg-muted`}>
                ...
                <button className="absolute bottom-4 right-4 p-3 bg-primary text-black rounded-full shadow-xl translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 z-10 flex items-center justify-center">
